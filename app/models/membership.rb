class Membership < ActiveRecord::Base
  ...
  after_create { self.user.update_mailchimp_subscription }
  ...
  #         groupings: [ 
  #           { name: 'Skills', groups: self.user.translated_skills },
  #           { name: 'Organizations', groups: self.user.organization_names }
  #         ]
  #       },
  #       double_optin: false,
